...
export default function HistoryScreen() {
  ...
  const filteredConversations = conversations.filter(c =>
    ...
    c.difficulty.toLowerCase().includes(searchText.toLowerCase())
  );
  ...
  const confirmDelete = (id) => {
    ...
    if (Platform.OS === 'web') {
      if (window.confirm('Remove this conversation from history?')) {
        doDelete();
      }
    } else {
          ...
          >
            <View style={styles.cardHeader}>
              <View style={styles.topicRow}>
                <View style={[styles.topicIconWrap, { backgroundColor: diffColor + '20' }]}>
                  <Ionicons name="book-outline" size={16} color={diffColor} />
                </View>
            ...
            <View style={styles.cardMeta}>
              ...
              <View style={styles.msgCountRow}>
                ...
                <Text style={styles.msgCount}>{item.messages?.length || 0} msgs</Text>
              </View>
            ...
            >
              <View style={styles.headerRow}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: SPACING.xs, flex: 1 }}>
                  <Ionicons name="school-outline" size={15} color={COLORS.textTertiary} />
                  <Text style={styles.headerText}>History</Text>
                  <Animated.View style={{ transform: [{ scale: countScale }] }}>
                    <View style={styles.countBadge}>
                      <Text style={styles.countBadgeText}>{filteredConversations.length}</Text>
                    </View>
                  </Animated.View>
                </View>
        ...
        <View style={styles.actionOverlay}>
          ...
          >
            ...
            >
              ...
              <Text style={styles.actionOptionText}>Open</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.actionOption}
...
const styles = StyleSheet.create({
  ...
  diffBadgeText: { fontSize: FONTS.sizes.caption1, fontWeight: '700' },
  msgCountRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.xs },
  msgCount: { color: COLORS.textTertiary, fontSize: FONTS.sizes.caption1 },
  dateText: { color: COLORS.textTertiary, fontSize: FONTS.sizes.caption1 },
  previewText: {
